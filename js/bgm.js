...
(function () {
  ...
  btn.addEventListener('click', function () {
    ...
    loadTone()
      ...
      .then(function () { loading = false; setBtn(false, false); startMusic(); })
      .catch(function () {
  ...
  /* 上次開著:顯示提示光圈吸引點擊,但絕不自動播放 */
  try { if (localStorage.getItem(PREF_KEY) === '1') btn.classList.add('had-on'); } catch (e) {}
})();
